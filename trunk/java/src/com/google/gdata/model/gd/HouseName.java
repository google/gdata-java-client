...
public class HouseName extends Element {
  ...
  public static final ElementKey<String,
      HouseName> KEY = ElementKey.of(new QName(Namespaces.gNs, "housename"),
      String.class, HouseName.class);
  ...
  public String toString() {
    return "{HouseName value=" + getTextValue() + "}";
  }
