...
public class FullName extends Element {
   ...
   */
  public FullName(ElementKey<String, ? extends FullName> key) {
    super(key);
  }
   ...
   */
  public FullName(ElementKey<String, ? extends FullName> key, Element source) {
    super(key, source);
  }
  ...
  public String toString() {
    return "{FullName value=" + getTextValue() + " yomi=" +
