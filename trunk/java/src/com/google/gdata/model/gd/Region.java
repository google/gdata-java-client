...
public class Region extends Element {
  ...
  public static final ElementKey<String,
      Region> KEY = ElementKey.of(new QName(Namespaces.gNs, "region"),
      String.class, Region.class);
   ...
   */
  public Region(ElementKey<String, ? extends Region> key) {
    super(key);
  }
   ...
   */
  public Region(ElementKey<String, ? extends Region> key, Element source) {
    super(key, source);
  }
  ...
  public String toString() {
    return "{Region value=" + getTextValue() + "}";
  }
