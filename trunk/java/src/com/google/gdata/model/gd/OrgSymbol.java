...
public class OrgSymbol extends Element {
  ...
  public static final ElementKey<String,
      OrgSymbol> KEY = ElementKey.of(new QName(Namespaces.gNs, "orgSymbol"),
      String.class, OrgSymbol.class);
   ...
   */
  public OrgSymbol(ElementKey<String, ? extends OrgSymbol> key) {
    super(key);
  }
  ...
  public String toString() {
    return "{OrgSymbol value=" + getTextValue() + "}";
  }
