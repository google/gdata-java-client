...
public class Who extends ExtensionPoint implements Extension {
  ...
  public static final class Rel {
    public static final String EVENT_ATTENDEE = Namespaces.gPrefix + "event.attendee";
    public static final String EVENT_ORGANIZER = Namespaces.gPrefix + "event.organizer";
    public static final String EVENT_SPEAKER = Namespaces.gPrefix + "event.speaker";
    public static final String EVENT_PERFORMER = Namespaces.gPrefix + "event.performer";
    public static final String TASK_ASSIGNED_TO = Namespaces.gPrefix + "task.assigned-to";
    public static final String MESSAGE_FROM = Namespaces.gPrefix + "message.from";
    public static final String MESSAGE_REPLY_TO = Namespaces.gPrefix + "message.reply-to";
  ...
  public static final class AttendeeType extends ValueConstruct {
    ...
    public static final String EVENT_REQUIRED = Namespaces.gPrefix + "event.required";
    public static final String EVENT_OPTIONAL = Namespaces.gPrefix + "event.optional";
  }
  ...
  public static final class AttendeeStatus extends ValueConstruct {
    ...
    public static final String EVENT_INVITED = Namespaces.gPrefix + "event.invited";
    public static final String EVENT_ACCEPTED = Namespaces.gPrefix + "event.accepted";
    public static final String EVENT_TENTATIVE = Namespaces.gPrefix + "event.tentative";
    public static final String EVENT_DECLINED = Namespaces.gPrefix + "event.declined";
  }
  ...
  protected class Handler extends ExtensionPoint.ExtensionHandler {
    ...
    protected Handler(ExtensionProfile extProfile, Class extendedClass)
        throws ParseException, IOException {
