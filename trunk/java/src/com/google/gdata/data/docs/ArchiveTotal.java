...
@ExtensionDescription.Default(
    ...
    localName = ArchiveTotal.XML_NAME)
public class ArchiveTotal extends AbstractExtension {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(ArchiveTotal.class);
  ...
  public boolean equals(Object obj) {
    ...
    ArchiveTotal other = (ArchiveTotal) obj;
  ...
  public String toString() {
    return "{ArchiveTotal value=" + value + "}";
  }
