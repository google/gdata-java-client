...
@ExtensionDescription.Default(
    ...
    localName = GphotoSnippetType.XML_NAME)
public class GphotoSnippetType extends ValueConstruct {
   ...
   *
   * @param value immutable snippet type or <code>null</code> for a mutable
   *     snippet type
   */
  public GphotoSnippetType(String value) {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GphotoSnippetType.class);
