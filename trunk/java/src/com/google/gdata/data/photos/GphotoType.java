...
public class GphotoType extends ValueConstruct {
   ...
   *
   * @param value immutable type name or <code>null</code> for a mutable type
   *     name
   */
  public GphotoType(String value) {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GphotoType.class);
