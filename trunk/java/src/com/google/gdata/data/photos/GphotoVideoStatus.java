...
@ExtensionDescription.Default(
    ...
    localName = GphotoVideoStatus.XML_NAME)
public class GphotoVideoStatus extends ValueConstruct {
   ...
   *
   * @param value immutable video status or <code>null</code> for a mutable
   *     video status
   */
  public GphotoVideoStatus(String value) {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GphotoVideoStatus.class);
