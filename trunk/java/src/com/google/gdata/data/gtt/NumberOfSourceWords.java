...
@ExtensionDescription.Default(
    ...
    localName = NumberOfSourceWords.XML_NAME)
public class NumberOfSourceWords extends AbstractExtension {
   ...
   * @param value value.
   */
  public NumberOfSourceWords(Integer value) {
    super();
    setValue(value);
    setImmutable(true);
  }
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(NumberOfSourceWords.class);
  ...
  public boolean equals(Object obj) {
    ...
    NumberOfSourceWords other = (NumberOfSourceWords) obj;
  ...
  public String toString() {
    return "{NumberOfSourceWords value=" + value + "}";
  }
