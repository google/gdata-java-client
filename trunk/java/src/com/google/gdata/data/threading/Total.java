...
public class Total extends AbstractExtension {
   ...
   *
   * @param value number of responses or <code>null</code> to reset
   */
   ...
   *
   * @return whether it has the number of responses
   */
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(Total.class);
