...
@ExtensionDescription.Default(
    ...
    localName = GwoExperimentType.XML_NAME)
public class GwoExperimentType extends AbstractExtension {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GwoExperimentType.class);
  ...
  public boolean equals(Object obj) {
    ...
    GwoExperimentType other = (GwoExperimentType) obj;
  ...
  public String toString() {
    return "{GwoExperimentType value=" + value + "}";
  }
