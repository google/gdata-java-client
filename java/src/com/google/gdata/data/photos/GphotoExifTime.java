...
@ExtensionDescription.Default(
    ...
    localName = GphotoExifTime.XML_NAME)
public class GphotoExifTime extends ValueConstruct {
   ...
   *
   * @param value immutable client string or <code>null</code> for a mutable
   *     client string
   */
  public GphotoExifTime(String value) {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GphotoExifTime.class);
