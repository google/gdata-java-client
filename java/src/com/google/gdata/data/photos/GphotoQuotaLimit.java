...
@ExtensionDescription.Default(
    ...
    localName = GphotoQuotaLimit.XML_NAME)
public class GphotoQuotaLimit extends AbstractExtension {
   ...
   *
   * @param value quotaLimit.
   */
  public GphotoQuotaLimit(Long value) {
    super();
    setValue(value);
    setImmutable(true);
  }
   ...
   * Sets the quotaLimit.
   *
   * @param value quotaLimit or <code>null</code> to reset
   */
   ...
   *
   * @return whether it has the quotaLimit
   */
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GphotoQuotaLimit.class);
  ...
  public boolean equals(Object obj) {
    ...
    GphotoQuotaLimit other = (GphotoQuotaLimit) obj;
  ...
  public String toString() {
    return "{GphotoQuotaLimit value=" + value + "}";
  }
