...
@ExtensionDescription.Default(
    ...
    localName = GwoAnalyticsAccountId.XML_NAME)
public class GwoAnalyticsAccountId extends ValueConstruct {
   ...
   */
  public GwoAnalyticsAccountId(String value) {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GwoAnalyticsAccountId.class);
