...
@ExtensionDescription.Default(
    ...
    localName = ArchiveTotalFailure.XML_NAME)
public class ArchiveTotalFailure extends AbstractExtension {
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(ArchiveTotalFailure.class);
  ...
  public boolean equals(Object obj) {
    ...
    ArchiveTotalFailure other = (ArchiveTotalFailure) obj;
  ...
  public String toString() {
    return "{ArchiveTotalFailure value=" + value + "}";
  }
