...
public class OrgTitle extends Element {
  ...
  public static final ElementKey<String,
      OrgTitle> KEY = ElementKey.of(new QName(Namespaces.gNs, "orgTitle"),
      String.class, OrgTitle.class);
   ...
   */
  public OrgTitle(ElementKey<String, ? extends OrgTitle> key) {
    super(key);
  }
   ...
   */
  public OrgTitle(ElementKey<String, ? extends OrgTitle> key, Element source) {
    super(key, source);
  }
  ...
  public String toString() {
    return "{OrgTitle value=" + getTextValue() + "}";
  }
