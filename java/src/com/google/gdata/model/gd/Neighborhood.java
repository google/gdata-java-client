...
public class Neighborhood extends Element {
  ...
  public static final ElementKey<String,
      Neighborhood> KEY = ElementKey.of(new QName(Namespaces.gNs,
      "neighborhood"), String.class, Neighborhood.class);
   ...
   */
  public Neighborhood(ElementKey<String, ? extends Neighborhood> key) {
    super(key);
  }
  ...
  public String toString() {
    return "{Neighborhood value=" + getTextValue() + "}";
  }
