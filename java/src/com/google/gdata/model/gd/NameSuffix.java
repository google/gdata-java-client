...
public class NameSuffix extends Element {
  ...
  public static final ElementKey<String,
      NameSuffix> KEY = ElementKey.of(new QName(Namespaces.gNs, "nameSuffix"),
      String.class, NameSuffix.class);
   ...
   */
  public NameSuffix(ElementKey<String, ? extends NameSuffix> key) {
    super(key);
  }
  ...
  public String toString() {
    return "{NameSuffix value=" + getTextValue() + "}";
  }
