...
public class PoBox extends Element {
  ...
  public static final ElementKey<String,
      PoBox> KEY = ElementKey.of(new QName(Namespaces.gNs, "pobox"),
      String.class, PoBox.class);
   ...
   */
  public PoBox(ElementKey<String, ? extends PoBox> key) {
    super(key);
  }
   ...
   */
  public PoBox(ElementKey<String, ? extends PoBox> key, Element source) {
    super(key, source);
  }
  ...
  public String toString() {
    return "{PoBox value=" + getTextValue() + "}";
  }
