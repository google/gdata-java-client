...
/** Abstract XML HTTP parser into an entity. */
public abstract class XmlHttpParser implements HttpParser {
  ...
  /**
   * Default implementation parses the content of the response into the entity
   * class, but subclasses may override.
   */
  public <T> T parse(HttpResponse response, Class<T> entityClass)
      throws IOException {
    InputStream content = response.getContent();
    try {
      T result = ClassInfo.newInstance(entityClass);
