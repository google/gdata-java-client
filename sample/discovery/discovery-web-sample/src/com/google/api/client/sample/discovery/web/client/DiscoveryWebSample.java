...
package com.google.api.client.sample.discovery.web.client;
 ...
 * @author Yaniv Inbar
 */
public class DiscoveryWebSample implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    addPanel.add(label);
    apiListBox.addItem("BigQuery", "bigquery");
    apiListBox.addItem("Discovery", "discovery");
    apiListBox.addItem("Google Buzz API", "buzz");
    apiListBox.addItem("Google Language API (Diacritization)", "diacritize");
    apiListBox.addItem("Google Latitude API", "latitude");
    apiListBox.addItem("Google Moderator API", "moderator");
    apiListBox.addItem("Google Prediction API", "prediction");
    ...
    mainPanel
        .add(
            new Anchor(
                "See Source Code",
                "http://code.google.com/p/gdata-java-client/source/browse/branches/2/sample/discovery/discovery-web-sample/"));
