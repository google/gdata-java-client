...
/**
 * OAuth 1.0a URL builder for an authorization web page to allow the end user to
 ...
 * {@link OAuthCallbackUri}.
 * 
 * @since 2.2
 */
public class OAuthAuthorizeTemporaryTokenUri extends UriEntity {

  /**
   * The temporary credentials token obtained from temporary credentials request
  ...
  public OAuthAuthorizeTemporaryTokenUri(String encodedUri) {
    super(encodedUri);
  }
}
